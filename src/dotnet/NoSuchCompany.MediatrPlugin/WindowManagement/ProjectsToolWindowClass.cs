...
namespace NoSuchCompany.ReSharperPlugin.FindMyHandlR.WindowManagement
{
    public class SampleToolWindow
    {
        ...
        (
            ...
            SampleToolWindowDescriptor sampleToolWindowDescriptor,
        ...
        )
        {
            ...
            _toolWindowInstance = _toolWindowClass.RegisterInstance(lifetime, "Sample Tool Window", null, (lt, twi) =>
            {
