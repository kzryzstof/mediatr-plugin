...
/**
 * #### Generated from [FindMyHandlRModel.kt:8]
 */
class FindMyHandlRModel private constructor(
    ...
    companion object : ISerializersOwner {
        ...
        const val serializationHash = -6640920857484616649L
        
    }
    override val serializersOwner: ISerializersOwner get() = FindMyHandlRModel
    override val serializationHash: Long get() = FindMyHandlRModel.serializationHash
    ...
    override fun print(printer: PrettyPrinter)  {
        printer.println("FindMyHandlRModel (")
        printer.indent {
    ...
    //deepClone
    override fun deepClone(): FindMyHandlRModel   {
        return FindMyHandlRModel(
...
val Solution.findMyHandlRModel get() = getOrCreateExtension("findMyHandlRModel", ::FindMyHandlRModel)



/**
 * #### Generated from [FindMyHandlRModel.kt:10]
 */
enum class MyEnum {
    FirstValue, 
    SecondValue;
...
/**
 * #### Generated from [FindMyHandlRModel.kt:15]
 */
