...
object MediatrModel : Ext(SolutionModel.Solution) {
    ...
    init {
        //setting(CSharp50Generator.Namespace, "ReSharperPlugin.FindMyHandlR.Rider.Model")
        //setting(Kotlin11Generator.Namespace, "com.jetbrains.rider.findmyhandlr.model")
